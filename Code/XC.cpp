...
static void xc_update_buttons(XC_STATE *state, ALLEGRO_EVENT event)
{
	...
	switch (event.joystick.button) {
		case 0:
			state->button_1 = value;
			break;
		case 1:
			state->button_2 = value;
			break;
		case 2:
			state->button_3 = value;
			break;
		case 3:
			state->button_4 = value;
			break;
		case 4:
		...
		case 5:
			...
			break;
		case 6:
			state->button_right_trigger = value;
			break;
		case 7:
			state->button_left_trigger = value;
			break;
		case 8:
...
void xc_clear_state(XC_STATE *state)
{
	...
	state->button_3 = false;
	state->button_4 = false;
	...
	state->button_right_trigger = false;
	state->button_left_trigger = false;
}
